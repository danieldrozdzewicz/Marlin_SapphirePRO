...
#define CUSTOM_MACHINE_NAME "Sapphire Pro 24"
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_WINDOW                  3  // (°C) Temperature proximity for the "temperature reached" timer //1
  #define TEMP_HYSTERESIS              5  // (°C) Temperature proximity considered "close enough" to the target //3
#endif
...
#define HEATER_0_MAXTEMP 320 //275  dodałem zmiany w thermistor_1.h !!!!
 ...
 */
#define HOTEND_OVERSHOOT 15   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT //było 15
...
#define EXTRUDE_MAXLENGTH 650 //900
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 430 }  // jakaś stara kalibracja była 444 więc zmieniam z 415 na 430 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 10, 50 } // było 45 w starym configu
 ...
 */
#define DEFAULT_ACCELERATION          2500 //2000    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1500 //1000    // E acceleration for retracts
...
// Uwagi w starym:  // ZAblokowałem dopiero teraz ponoć przeszkadza linear_adv !!!!
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { 0, -42, 0 } - to oryginalne z tej wersji !!!
#define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }  //wstawiłem stare
...
// Mamy problemy z homing - nie mam probe 
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  //#define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.   // w starym włączone
 ...
 */
#define SD_CHECK_AND_RETRY  // domyślnie wył. 
