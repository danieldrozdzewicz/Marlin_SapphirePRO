 ...
 */
#if ENABLED(THERMAL_PROTECTION_HOTENDS)                  // w starym:
  #define THERMAL_PROTECTION_PERIOD 40        // (seconds) //45
  #define THERMAL_PROTECTION_HYSTERESIS 4     // (°C)      //5
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  40               // (seconds)  //25
  #define WATCH_TEMP_INCREASE 4               // (°C)       // 2
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        20 // (seconds)  // 35
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // (°C)       // 3
...
#define RX_BUFFER_SIZE 1024 //było wył !

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF //było wył !
#endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define E0_CURRENT      800  //było 950 !!!!
  ...
  // ZE STAREGO GDY NIE BĘDĄ w STANDALONE:
  #define  X_SLAVE_ADDRESS 3  // |  |  :    3
  #define  Y_SLAVE_ADDRESS 2  // :  |  :    2
  #define  Z_SLAVE_ADDRESS 1  // |  :  :    1
   ...
   */
  #define TMC_DEBUG  //było wył i ze STANDALONE może musi być wył !!!
